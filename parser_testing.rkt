...
(define Tokens (list (integer_Token "1")
                     (string_Token "test")
                     (boolean_Token "True ")
                     (boolean_Token "False ")
                     (while_Token "while ")
...
(check equal? (Boolean_Expression-value (ParseResult-result (first (toplevelparse 2 (list))))) "True ")

(check equal? (Boolean_Expression-value (ParseResult-result (first (toplevelparse 3 (list))))) "False ")

(check equal? (While_Statement-value (ParseResult-result (first (toplevelparse 4 (list))))) "while ")

(check equal? (If_Expression-value (ParseResult-result (first (toplevelparse 5 (list))))) "if ")

(check equal? (Or_Statement-value (ParseResult-result (first (toplevelparse 6 (list))))) "or ")

(check equal? (Fail_Statement-value (ParseResult-result (first (toplevelparse 7 (list))))) "fail ")

(check equal? (Print_Statement-value (ParseResult-result (first (toplevelparse 8 (list))))) "print ")

(check equal? (Function_Expression-value (ParseResult-result (first (toplevelparse 9 (list))))) "def ")

(check equal? (Enum_Statement-value (ParseResult-result (first (toplevelparse 10 (list))))) "enum ")

(check equal? (Switch_Statement-value (ParseResult-result (first (toplevelparse 11 (list))))) "switch ")

(check equal? (Variable_Expression-value (ParseResult-result (first (toplevelparse 12 (list))))) "x ")

(check equal? (Additive_Expression-value (ParseResult-result (first (toplevelparse 13 (list))))) "+")

(check equal? (Multiplicative_Expression-value (ParseResult-result (first (toplevelparse 14 (list))))) "*")
